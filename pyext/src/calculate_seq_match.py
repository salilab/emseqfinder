...
def main():
    ...
    print(result_file, "total percentage matched ",
          round(100*(total_residue_matched/total_residue), 3))
    print(result_file, "total abs percentage matched ",
          round(100*(total_residue_matched_abs/total_residue), 3))
